...
public class WebsiteConfigVO
{
     ...
     * 网站一言
     */
    @ApiModelProperty(name = "websiteWord", value = "网站一言", required = true, dataType = "String")
    private String websiteWord;
     ...
     * 网站创建时间
     */
    @ApiModelProperty(name = "websiteCreateTime", value = "网站创建时间", required = true, dataType = "Date")
     ...
     * 后台登录页面背景
     */
    @ApiModelProperty(name = "adminCover", value = "后台登录页面背景", required = true, dataType = "String")
    private String adminCover;
