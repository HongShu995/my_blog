...
import com.hongshu.dao.RoleResourceDao;
...
public class ResourceServiceImpl extends ServiceImpl<ResourceDao, Resource> implements ResourceService
{
    ...
    public void importSwagger()
    {
        ...
        Map<String, Object> data = restTemplate.getForObject("http://localhost:8090/v2/api-docs", Map.class);
        System.out.println("===============================");
    ...
    public void deleteResource(Integer resourceId)
    {
        ...
        if (count > 0) {
            throw new BlogException("该资源下存在角色");
        }
        // 删除子资源
